...
function ($scope, $location, $rootScope, $element) {
    ...
    if ($rootScope.langID.startsWith('en')) {
        $rootScope.barney = 'barney rubble';
    }
    else if ($rootScope.langID.startsWith('ja')) {
        $rootScope.barney = '######## rubble';
    }
    else {
        $rootScope.barney = 'betty rubble';
    }
