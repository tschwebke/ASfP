asfpApp.controller('orderController', ['$scope', '$location', '$rootScope',
    function ($scope, $location, $rootScope, $element) {
        ...
        if ($rootScope.langID.startsWith('ja')) {
            ...
            $rootScope.description = 'Elevate your cloud business with Microsoft’s Advanced Support for Partners. Getting started is easy, just fill out the form below and you will be contacted by a Microsoft representative to review your order request and activate a contract for your organization.';
            ...
            $rootScope.optionalpackagetitle = 'Add Optional Packages to your Contract';
            $rootScope.optionalpackagedescription = 'Choose from our three additional packages that can help you address specialized support scenarios or technologies by checking the box next to your desired package. Packages are paid up-front and require an active Advanced Support for Partners contract from your organization.';
            ...
            $rootScope.additionalcloudconsultdescription = 'Cloud Consults offer a remote one-to-one, in-depth technical consultation with a Microsoft Cloud Expert to provide guidance on various stages of your cloud projects.';
            $rootScope.onpremiseselect = 'On-Premises Support Incidents';
            $rootScope.onpremiseselectdescription = 'Professional Support is available as a 5-pack of incidents. Professional Support incidents focus on troubleshooting a specific problem, error message, or functionality that is not working as intended for Microsoft products.';
